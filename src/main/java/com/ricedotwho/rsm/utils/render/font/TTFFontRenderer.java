...
public class TTFFontRenderer {
    ...
    public void drawString(String text) {
        renderString(text, 0, 0, FatalityColours.TEXT, false);
    }
    ...
    private void setup(char character) {
        ...
        if (antiAlias) {
            ...
            graphics.setRenderingHint(RenderingHints.KEY_TEXT_LCD_CONTRAST, 140); // improves LCD smoothing
        }
    ...
    private void createTexture(int textureId, BufferedImage image) {
        ...
        GlStateManager._texImage2D(3553, 0, 6408, image.getWidth(), image.getHeight(), 0, 6408, 5121, buffer);
    }
    ...
    private void renderString(String text, float x, float y, Colour colour, boolean shadow) {
        ...
        NVGUtils.colour4f(r / multiplier, g / multiplier, b / multiplier, a);
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (character == FORMATTER) {
                ...
                if (index < 16) {
                    ...
                    NVGUtils.colour4f((textColor >> 16) / 255.0F, (textColor >> 8 & 255) / 255.0F, (textColor & 255) / 255.0F, a);
                } else if (index == 16)
                    obfuscated = true;
                else if (index == 18)
                    strikethrough = true;
                    ...
                    NVGUtils.colour4f(1 / multiplier, 1 / multiplier, 1 / multiplier, a);
                }
            } else {
