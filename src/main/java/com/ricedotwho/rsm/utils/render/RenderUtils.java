...
//    }
    ...
    public void drawRoundedRect(GuiGraphics gfx, double x, double y, double width, double height, double radius, Color color) {
        drawSetup();
    ...
    public void drawRoundedRectOutlineGradient(GuiGraphics gfx, int x, int y, int width, int height, int radius, float thickness, Color... colors) {
        drawSetup();
