...
public class KeyShortcutGui extends Screen implements Accessor {
    ...
    public void extractRenderState(GuiGraphicsExtractor gfx, int mouseX, int mouseY, float deltaTicks) {
        ...
        NVGSpecialRenderer.draw(gfx, 0, 0, gfx.guiWidth(), gfx.guiHeight(), () -> {
            ...
            NVGUtils.drawText("New Shortcut", buttonX + (94f - NVGUtils.getTextWidth("New Shortcut", 12, font)) / 2, buttonY + NVGUtils.getTextHeight(12, font) / 2 + 2, 12, FatalityColours.TEXT, font);
    ...
    private void drawShortCuts(GuiGraphicsExtractor gfx, double mouseX, double mouseY) {
