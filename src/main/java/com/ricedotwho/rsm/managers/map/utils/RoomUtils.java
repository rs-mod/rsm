...
import com.ricedotwho.rsm.managers.map.map.RoomRotation;
import com.ricedotwho.rsm.managers.map.map.RoomType;
...
import static com.ricedotwho.rsm.managers.map.map.RoomRotation.TOPLEFT;
