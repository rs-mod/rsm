...
public class TerminalSolver extends Module {
    ...
    private final ColorSetting background = new ColorSetting("Background", Color.fromHSBA(0F, 0F, 12F, 217F));
    private final ColorSetting textColor = new ColorSetting("Text Colour", Color.fromRGB(220, 220, 220));
    private final ColorSetting panesColor = new ColorSetting("Panes", Color.fromHSBA(144F, 76F, 56F,255F));
    private final ColorSetting rubix = new ColorSetting("Rubix", Color.fromHSVA(144F, 76F, 56F,255F));
    private final ColorSetting oppRubix = new ColorSetting("Opposite Rubix", Color.fromHSBA(184F, 76F, 56F, 255F));
    private final ColorSetting order = new ColorSetting("Order", Color.fromHSBA(144F, 76F, 56F,255F));
    private final ColorSetting order2 = new ColorSetting("Order 2", Color.fromHSBA(144F, 76F, 47F,128F));
    private final ColorSetting order3 = new ColorSetting("Order 3", Color.fromHSBA(145F, 77F, 40F,77F));
    private final ColorSetting startsWith = new ColorSetting("Starts With", Color.fromHSBA(144F, 76F, 56F,255F));
    private final ColorSetting select = new ColorSetting("Select", Color.fromHSBA(144F, 76F, 56F,255F));
