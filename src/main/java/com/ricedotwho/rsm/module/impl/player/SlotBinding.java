...
public class SlotBinding extends Module {
    ...
    public void onSlotClick(GuiEvent.SlotClick event) {
        ...
        mc.gameMode.handleContainerInput(container.getMenu().containerId, invSlot, hotbar, ContainerInput.SWAP, mc.player);
    }
    ...
    private void drawLine(GuiGraphicsExtractor gfx, int x, int y, int x2, int y2, int width, int argb) {
