...
public class Ether extends Module implements CameraPositionProvider {
    ...
    private int dragonHurtSoundSuppressQueue = 0;
    ...
    public void onReceiveSound(PacketEvent.Receive event) {
        if (!this.isEnabled() || !this.etherwarpSound.getValue() || dragonHurtSoundSuppressQueue <= 0) return;
...
//            Pos prediction = EtherUtils.predictTeleport(eyePos, yaw,  pitch, distance);
    ...
    public void reset() {
        ...
        this.renderPos = null;
        this.lastWIMP = 0;
        this.dragonHurtSoundSuppressQueue = 0;
    }
