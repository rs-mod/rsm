...
public class Module extends ModuleBase {
    ...
    public void saveConfig() {
        ...
        moduleObject.addProperty("keybind", keybind.getKeyBind().getName());
        ...
        for (GroupSetting<?> s : groupSettings) {
            ...
            for (Setting<?> s2 : sub.getSettings()) {
                if (s2.doesNotSaveToConfig() || s2.isNotPersistent()) continue;
    ...
    public void loadConfig() {
        ...
        try {
            ...
            try {
                ...
                keybind.setKeyBind(InputConstants.getKey(moduleObject.get("keybind").getAsString()));
            } catch (Exception e) {
    ...
    private void loadGroup(JsonObject group) {
        ...
        try {
            ...
            sub.getKeybind().setKeyBind(InputConstants.getKey(group.get("keybind").getAsString()));
        } catch (Exception e) {
            // ignored
        }
