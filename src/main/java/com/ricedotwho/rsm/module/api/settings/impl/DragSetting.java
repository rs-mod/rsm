...
public class DragSetting extends Setting {
    ...
    public void text(GuiGraphicsExtractor gfx, String content, Align align, int x, int y, Color color, boolean shadow) {
        ...
        gfx.text(mc.font, content, x + offset, y, color.getARGB(), shadow);
    }
