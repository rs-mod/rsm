...
@Getter
@Setter
public class SaveSetting<T> extends Setting<T> {
    ...
    public SaveSetting(String name, String path, String defaultFile, Supplier<T> factory, Type type, String description) {
        this(name, path, defaultFile, factory, type, true, false, null, description);
    }

    public SaveSetting(String name, String path, String defaultFile, Supplier<T> factory, Type type, boolean allowEdits, String description) {
        this(name, path, defaultFile, factory, type, true, allowEdits, null, description);
    }

    public SaveSetting(String name, String main, String path, String defaultFile, Supplier<T> factory, Type type, boolean allowEdits, String description) {
        this(name, main, path, defaultFile, factory, type, true, allowEdits, null, description);
    }

    public SaveSetting(String name, String path, String defaultFile, Supplier<T> factory, Type type, Runnable action, String description) {
        this(name, path, defaultFile, factory, type, true, false, action, description);
    }

    public SaveSetting(String name, String path, String defaultFile, Supplier<T> factory, Type type, boolean allowEdits, Runnable action, String description) {
        this(name, path, defaultFile, factory, type, true, allowEdits, action, description);
    }
