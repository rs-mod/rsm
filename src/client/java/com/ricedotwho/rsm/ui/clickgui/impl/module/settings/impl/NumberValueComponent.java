...
public class NumberValueComponent extends ValueComponent<NumberSetting> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtils.drawRoundedRect(dropdownX + 1, dropdownY + 1, lastWidth, rectHeight - 2, 1, FatalityColors.SELECTED);
        ...
        RenderUtils.drawRoundedRect(inputX, dropdownY, inputWidth, rectHeight, 2, boxColor);
